...
public class DanhSachPlaylistAdapter extends RecyclerView.Adapter<DanhSachPlaylistAdapter.ViewHolder> {
    ...
    Playlist playlist= arrayPlaylist.get(position);
        Picasso.with(context).load(playlist.getImagePlaylist()).into(viewHolder.imgBackgroundPlaylist);
        viewHolder.txtViewNamePlaylist.setText(playlist.getNamePlaylist());
...
//        LayoutInflater inflater = LayoutInflater.from(context);
//        View view = inflater.inflate(R.layout.dong_danhsach_playlist, null);
//
//        return new ViewHolder(view);
//    }
//
...
//        Playlist playlist = arrayPlaylist.get(po)
//    }
//
//    @Override
//    public int getItemCount() {
